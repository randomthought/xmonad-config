...
myFont      = "xft:Zekton:size=7:bold:antialias=true"
myBigFont   = "xft:Zekton:size=7:bold:antialias=true"
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  -- Scratchpads
    ...
    , ((mod4Mask          , xK_z        ), scratchpadSpawnActionCustom "termite --name scratchpad")
  ]
  ++
...
defaults = def {
    ...
    manageHook         = manageDocks <+> myManageHook <+> dropdownTerminal,
